...
const result1 = document.getAnimations("result1"); // span
...
const result2 = document.getAnimations("result2"); // span
...
// 누적
function plus4 () {
  const value = Namber(input4.value);
  // count4= count4 + value;
  count4 += value;
  result4.innerText = count4;
}
...
function cheakFn5 () {
  ...
  // 50은 70 이하이고, 4의 배수인가?
  const boo12 = (50 <= 70) && (50 % 4 ==0);
  console.log('50은 70 이하이고, 4의 배수인가? ${boo12}')
