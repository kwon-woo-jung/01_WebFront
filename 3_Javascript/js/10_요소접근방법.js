...
function cssTest() {
  ...
  // [요소 n개 -> 배열]
  // 2) document.quertSelectorAll("CSS 선택자");
  ...
  // 두번째 자식 div
  const div2 = document.querySelector('[target-div="css-div"]')
  div1.innerText = "첫번째 요소가 아니면 querySelector() 특징 활용 못함";
